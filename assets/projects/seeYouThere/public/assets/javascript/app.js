	...
	$("#btnLogIn").on("click", function(){
		...
		firebase.auth().signInWithEmailAndPassword(email, password).catch(function(error) {
			...
			if (errorCode == "auth/user-not-found"){
				...
				$("#error-div-log").html("** Looks like that email hasn't registered yet. **")
			} else if (errorCode == "auth/wrong-password"){
				console.log("thats the next code")
				$("#error-div-log").html("** Whoops, wrong password. **")
			};
		});
	});
	...
	$("#btnSignUp").on("click", function(snap){
		...
		firebase.auth().createUserWithEmailAndPassword(email, password).catch(function(error) {
			...
			if (errorCode == "auth/email-already-in-use"){
				$("#error-div-sign").html("** Looks like that email is already registered. **")
			};
		});
	});
